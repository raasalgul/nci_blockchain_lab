...
// configure the environmental file
require('dotenv').config()

// Loading the infura token from environmental file
infuraToken = process.env.INFURA_TOKEN

// Loading the contract address from environmental file
contractAddress = process.env.CONTRACT_ADDRESS_3

// Loading my contract address from environmental file
...
// instantiate web3 with this RPC URL
...
// get the total supply of coints
...
// get the total decimals in the token
...
module.exports = { getSymbol, getDecimals, getBalanceOfAccount, getName, getTotalSupply }
